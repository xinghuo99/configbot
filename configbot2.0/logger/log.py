...
def _get_logs_dir() -> Path:
    """获取日志目录路径（xiaohua/logs/）"""
    # 从 configbot/log.py 向上找到项目根目录
...
def log_info_no_newline(message: str, level: str = "info") -> None:
    """不换行输出到控制台（如交互提示符），同时写入日志"""
